...
import br.com.lemontech.selfbooking.wsselfbooking.beans.solicitacaotolistarcentrodecusto.SolicitacaoToListarCentroDeCusto;
...
/**
 * <p>Classe Java de listarSubCentroDeCustoResponse complex type.
 * 
 * <p>O seguinte fragmento do esquema especifica o conteúdo esperado contido dentro desta classe.
 * 
 * <pre>
 * &lt;complexType name="listarSubCentroDeCustoResponse"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="solicitacao" type="{http://lemontech.com.br/selfbooking/wsselfbooking/beans/solicitacaotolistarcentrodecusto}solicitacaoToListarCentroDeCusto" maxOccurs="unbounded" minOccurs="0"/&gt;
...
@XmlType(name = "listarSubCentroDeCustoResponse", propOrder = {
    "resultadoAcao",
    "numeroSolicitacoes",
    "solicitacao",
    "mensagemRetorno"
})
public class ListarSubCentroDeCustoResponse {

    @XmlSchemaType(name = "string")
    protected ResultadoAcao resultadoAcao;
    protected Integer numeroSolicitacoes;
    protected List<SolicitacaoToListarCentroDeCusto> solicitacao;
     ...
     * {@link SolicitacaoToListarCentroDeCusto }
     * 
     * 
     */
    public List<SolicitacaoToListarCentroDeCusto> getSolicitacao() {
        if (solicitacao == null) {
            solicitacao = new ArrayList<SolicitacaoToListarCentroDeCusto>();
        }
